...
TriggerEvent('esx_society:registerProperty', 'ballas', 'ballas', 'property_black_money_ballas', 'property_black_money_ballas', 'property_black_money_ballas', {type = 'public'})
...
ESX.RegisterServerCallback('esx_ballasjob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'property_black_money_ballas', function(account)
