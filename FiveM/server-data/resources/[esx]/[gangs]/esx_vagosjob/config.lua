...
Config.CircleZones = {
    DrugDealer = {coords = vector3(344.95, -2051.40, 20.96), name = _U('map_blip'), color = 46, sprite = 84, radius = 110.0},
}
...
--			-- { name = 'WEAPON_GUSENBERG',        price = 17500 },
		...
		Cloakrooms = {
			{ x = 348.451, y = -2058.796, z = 22.245 },
		},

		Armories = {
			{ x = 350.024, y = -2056.825, z = 22.245 },
		},
