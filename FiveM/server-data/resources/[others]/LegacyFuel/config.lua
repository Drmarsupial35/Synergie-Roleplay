...
-- Are you using ESX? Turn this to true if you would like fuel & Jerrycans to cost something.
Config.UseESX = true

-- What should the price of Jerrycans be?
...
Config.Strings = {
	...
	EToRefuel = "Appyuez sur ~g~E~w~ pour faire le plein du véhicule",
	JerryCanEmpty = "Le Jerrycan est vide",
	FullTank = "Le réserveoir est plein",
	PurchaseJerryCan = "Appuyez sur ~g~E~w~ pour acheter un Jerrycan pour ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyez sur ~g~E~w~ pour arrêter de faire le plein",
	CancelFuelingJerryCan = "Appuyez sur ~g~E~w~ pour arrêter de faire le plein",
