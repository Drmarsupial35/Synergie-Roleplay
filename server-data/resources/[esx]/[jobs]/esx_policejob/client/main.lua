...
function OpenCloakroomMenu()
	...
	elseif grade == 'sergeantChef' then
	...
	elseif grade == 'lieutenantChef' then
		table.insert(elements, {label = _U('police_wear'), value = 'lieutenantChef_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'sergeantChef_wear' or
			data.current.value == 'lieutenant_wear' or
			data.current.value == 'lieutenantChef_wear' or
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {
			...
			{label = "Interaction prison ", value = 'jail_menu'},
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				{label = _U('ppa_adding'), value = 'ppa_add'}
			}
