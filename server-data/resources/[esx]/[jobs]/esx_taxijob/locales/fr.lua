Locales['fr'] = {
  ...
  ['cloakroom_prompt'] = 'appuyer sur ~INPUT_CONTEXT~ pour ouvrir le ~y~vestiaire~s~.',
  ['wear_citizen'] = 'Tenue civile',
  ['wear_work'] = 'Tenue de chauffeur',
  ...
  ['spawnpoint_blocked'] = 'un véhicule bloque le point d\'apparition !',
  ...
  ['start_job'] = 'début / fin des courses PNJ',
