...
Config.AuthorizedVehicles = {
	...
	ambulance = {
		{ model = 'ambulance', label = 'Ambulance', price = 5000}
	},

	doctor = {
		{ model = 'ambulance', label = 'Ambulance', price = 4500},
		{ model = 'dodgeems', label = 'Dodge Charger EMS', price = 4500}
	},

	chief_doctor = {
		{ model = 'ambulance', label = 'Ambulance', price = 3000},
		{ model = 'dodgeems', label = 'Dodge Charger EMS', price = 4500}
	},
