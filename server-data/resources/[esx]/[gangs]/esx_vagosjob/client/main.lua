    ...
    while true do
        ...
        if ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'vagos' then
            ...
            for k, v in pairs(Config.VagosStations) do
                ...
                if Config.EnablePlayerManagement and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'vagos' and ESX.PlayerData.job2.grade_name == 'boss' then
...
Citizen.CreateThread(function()
    while true do
        ...
        if CurrentAction ~= nil then
            ...
            if IsControlJustReleased(0, 38) and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'vagos' then
        ...
        if IsControlJustReleased(0, 168) and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') then
