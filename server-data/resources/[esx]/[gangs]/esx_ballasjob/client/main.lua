...
function OpenCloakroomMenu()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		elseif data.current.value == 'ballas_wear' then
    ...
    Wait(10)
		...
		if ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'ballas' then
			...
			for k,v in pairs(Config.ballasStations) do
				...
				if Config.EnablePlayerManagement and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'ballas' and ESX.PlayerData.job2.grade_name == 'boss' then
...
Citizen.CreateThread(function()
	...
	if CurrentAction ~= nil then
		...
		if IsControlJustReleased(0, 38) and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'ballas' then
		...
		if IsControlJustReleased(0, 168) and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'ballas' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'ballas_actions') then
