    ...
    while true do
        ...
        if ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'mafia' then
            ...
            for k, v in pairs(Config.MafiaStations) do
                ...
                if Config.EnablePlayerManagement and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'mafia' and ESX.PlayerData.job2.grade_name == 'boss' then
...
function CreateBlip()
    if ESX.PlayerData.job2 ~= nill and ESX.PlayerData.job2.name == 'mafia' then
        if MafiaBlip == nil then
            MafiaBlip = AddBlipForCoord(-2653.963, 1326.674, 147.398)

            SetBlipHighDetail(MafiaBlip, true)
            SetBlipSprite(MafiaBlip, 378)
            SetBlipScale(MafiaBlip, 1.0)
            SetBlipColour(MafiaBlip, 76)
            SetBlipAsShortRange(MafiaBlip, true)

            BeginTextCommandSetBlipName("STRING")
            AddTextComponentString("Mafia | Quartier Général")
...
Citizen.CreateThread(function()
    while true do
        ...
        if CurrentAction ~= nil then
            ...
            if IsControlJustReleased(0, 38) and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'mafia' then
        ...
        if IsControlJustReleased(0, 168) and ESX.PlayerData.job2 ~= nil and ESX.PlayerData.job2.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') then
