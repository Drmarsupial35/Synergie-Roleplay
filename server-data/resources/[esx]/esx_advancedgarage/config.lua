...
Config.CarGarages = {
	...
	Garage_OuestLS = {
		GaragePoint = { x = -1133.016, y = -759.609, z = 17.966 },
		SpawnPoint = { x = -1133.016, y = -759.609, z = 17.966, h = 315.01 },
		DeletePoint = { x = -1145.895, y = -744.991, z = 18.689 },
		active = true
	},
	Garage_SudLS = {
		GaragePoint = { x = -50.524, y = -1684.530, z = 28.489 },
		SpawnPoint = { x = -50.524, y = -1684.530, z = 28.489, h = 315.01 },
		DeletePoint = { x = -22.485, y = -1677.186, z = 28.488 },
		active = true
	},
	Garage_Police = {
		GaragePoint = { x = 436.203, y = -996.772, z = 24.767 },
		SpawnPoint = { x = 436.203, y = -996.772, z = 24.767, h = 173.304 },
		DeletePoint = { x = 452.616, y = -997.512, z = 24.756 },
		active = false
	},
	Garage_Ambulance = {
		GaragePoint = { x = 330.255, y = -1467.663, z = 28.738 },
		SpawnPoint = { x = 330.255, y = -1467.663, z = 28.738, h = 227.321 },
		DeletePoint = { x = 324.561, y = -1474.786, z = 28.810 },
		active = false
	},
	Garage_Mecano = {
		GaragePoint = { x = -191.260, y = -1284.535, z = 30.230 },
		SpawnPoint = { x = -191.260, y = -1284.535, z = 30.230, h = 269.962 },
		DeletePoint = { x = -190.580, y = -1289.921, z = 30.296 },
		active = false
	},
	Garage_Concess = {
		GaragePoint = { x = -8.508, y = -1081.579, z = 25.672 },
		SpawnPoint = { x = -8.508, y = -1081.579, z = 25.672, h = 115.357 },
		DeletePoint = { x = -37.696, y = -1088.185, z = 25.422 },
		active = false
	},
	Garage_Taxi = {
		GaragePoint = { x = 903.621, y = -191.960, z = 72.789 },
		SpawnPoint = { x = 903.621, y = -191.960, z = 72.789, h = 43.301 },
