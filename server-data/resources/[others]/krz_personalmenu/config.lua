...
-- GENERAL --
Config.MenuTitle = 'Synergie' -- change it to you're server name
...
Config.GPS = {
	...
	{label = 'Garage Central', coords = vector2(210.07, -804.51)},
	{label = 'Hôpital', coords = vector2(297.41, -1442.52)},
	{label = 'Concessionnaire', coords = vector2(-66.37, -1105)},
	{label = 'Mécanos', coords = vector2(-212.13, -1325.27)},
